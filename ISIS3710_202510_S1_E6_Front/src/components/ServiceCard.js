...
const ServiceCard = ({
  ...
  scheduledDate,
  address,
  client,        // eliminamos clientImg
  onAccept,
  onReject,
}) => {
  // Generar color de fondo para el avatar según el nombre del cliente
  ...
  const avatarColor = client ? stringToColor(client) : "#ccc";
...
ServiceCard.propTypes = {
  idServicio: PropTypes.string.isRequired,
